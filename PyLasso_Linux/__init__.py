# -*- coding: utf-8 -*-
# PyLasso: A PyMOL plugin to identify lassos, version for Linux platform
...
class PyLasso:
    def __init__(self, app):
        ...
        self.python_compiler = [get_python_exec(), plugin_path + os.sep + 'convert_pdb_2_5columns.py']
    ...
    def convert_to_5columns_format(self):
        ...
        if self.is_trajectory:
            ...
            print(self.python_compiler + [self._full_path_to_file])
    ...
    def draw_lassos_type_chart(self):
        ...
        chart_lassos_type.subplots_adjust(top=0.96, bottom=0.16, left=0.07, right=0.98)
        ax = chart_lassos_type.add_subplot(111)
        ax.set_xlabel('Frame')
    ...
    def draw_atoms_piercing_lasso_chart(self):
        ...
        chart_atoms_piercing.subplots_adjust(top=0.96, bottom=0.26, left=0.06, right=0.98)
    ...
    def display_gln_objects(self):
        ...
        if self.lasinf_is_gln_selected.get():
            ...
            gln_matrix_1.subplots_adjust(top=0.97, bottom=0.17, left=0.15, right=0.97)
            ...
            gln_matrix_2.subplots_adjust(top=0.97, bottom=0.17, left=0.15, right=0.97)
